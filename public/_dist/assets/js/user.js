...
function UserController(myServiceUser, myServiceCurso) {
  ...
  vm.submitFormCreate = submitFormCreate;
  function submitFormCreate(user) {
 
  console.log('submitFormCreate', user);
   if( user.type == undefined ){
     vm.error_message = "Favor selecione o tipo de usuário";
     console.log("error_mensage",vm.error_message)
     return false
   }  
  ...
  myServiceUser
    ...
    .then(function successCallback(response) {
         ...
         var new_user = [
          ...
          vm.error_message = "Usuário, cadastrado com sucesso.";
          ...
          .then(function successCallback(response) {     
               ...
               vm.error_message = "Aluno Cadastrado com sucesso.";
               vm.form = {};
            }, function errorCallback(response) {
              console.log("Error: ",response.data);
              console.log("Error Aluno, algo estranho aconteceu.");
              vm.error_message = "Error Aluno, algo estranho aconteceu.";
          });
      }, function errorCallback(response) {
        console.log("Error: ",response.data);
        vm.error_message = "Error User, algo estranho aconteceu.";
